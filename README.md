...
ผมเริ่มค้นคว้าและพบว่าเราสามารถสร้างเว็บแอปพลิเคชันง่ายๆ โดยใช้เครื่องมือที่ไม่ซับซ้อนและ **ไม่มีค่าใช้จ่าย** อย่าง GitHub Pages สำหรับหน้าเว็บ และ Google Sheets เป็นฐานข้อมูลได้ นั่นดูเป็นทางออกที่เหมาะสมสำหรับร้านเล็กๆ ของแม่ผม
...
ผมเชื่อว่าระบบ "ข้าวต้มปลาสื่อรัก" (หรือชื่อใดก็ตามที่คุณจะนำไปปรับใช้) นี้ ไม่ได้มีประโยชน์แค่กับร้านของแม่ผมเท่านั้น แต่ยังสามารถเป็นประโยชน์กับร้านอาหารขนาดเล็กถึงขนาดกลางอื่นๆ ในประเทศไทยอีกมากมาย โดยเฉพาะร้านที่:
